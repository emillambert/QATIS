...
def configure(
    ...
    scraping_robot_api_key: Optional[str] = typer.Option(None, help="Scraping Robot API key"),
    serpapi_api_key: Optional[str] = typer.Option(None, help="SerpAPI API key (fallback)"),
    ...
    if scraping_robot_api_key is None:
        scraping_robot_api_key = typer.prompt("SCRAPING_ROBOT_API_KEY", default=load_keys().scraping_robot_api_key or "", hide_input=True) or None
    if serpapi_api_key is None:
        serpapi_api_key = typer.prompt("SERPAPI_API_KEY (optional)", default=load_keys().serpapi_api_key or "", hide_input=True) or None

    save_keys(Keys(openai_api_key, scraping_robot_api_key, serpapi_api_key))
